...
mod tests {
    ...
    // You'll need to uncomment these once you have the actual uint types
    /*
    #[test]
    fn test_signed_basic_operations() {
        let a = I256::from(42i64);
        let b = I256::from(-24i64);
        
        assert_eq!(a + b, I256::from(18i64));
        assert_eq!(a - b, I256::from(66i64));
        assert_eq!(a * b, I256::from(-1008i64));
    ...
    fn test_signed_limits() {
        ...
        assert_eq!(I256::MIN.checked_neg(), None); // overflow
    }
    
    #[test] 
    fn test_signed_comparison() {
        let pos = I256::from(100i64);
        let neg = I256::from(-50i64);
        let zero = I256::zero();
